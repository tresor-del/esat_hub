...
const HomeSidebarAppInfo = ({ className }) => {
  ...
  //   const cities = [
  //     { name:'IA',     lat:6.14,  lng:1.21   },
  //     { name:'Cyber Sécurité',    lat:48.86, lng:2.35   },
  //     { name:'Génie Logiciel', lat:40.71, lng:-74.01 },
  //     { name:'Mécanique',    lat:35.68, lng:139.65 },
  //     { name:'Aviation',      lat:-22.91,lng:-43.17 },
